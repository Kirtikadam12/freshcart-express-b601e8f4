  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-semibold transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0 active:scale-[0.98]",
  {
    variants: {
      variant: {
        ...
        fresh: "gradient-fresh text-primary-foreground shadow-card hover:shadow-elevated",
        citrus: "gradient-citrus text-primary-foreground shadow-card hover:shadow-elevated",
        cart: "bg-primary text-primary-foreground shadow-soft hover:opacity-90 rounded-full",
        category: "bg-fresh-green-light text-foreground border border-primary/20 hover:bg-primary hover:text-primary-foreground",
      },
      size: {
